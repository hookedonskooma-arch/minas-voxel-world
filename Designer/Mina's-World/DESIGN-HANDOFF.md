# 840c2d78-f5ed-47cc-a52b-bacd570f26bb implementation handoff

This archive is the source of truth for turning the design into production code. Start from `landing.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
- A single self-contained `landing.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `landing.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `screens/02-avatar.html`
- `screens/03-world-builder.html`
- `screens/04-friend-visit.html`
- `screens/05-quest-map.html`
- `template.html`
- `widgets.html`

## Styles
- `styles/mina-world.css`

## Scripts/components
- `scripts/mina-world.js`
...
- `HANDOFF.md`
- `mp7t005u-Mina.jpeg`
- `mp7vobk7-Screenshot-2026-05-16-at-1.00.31-AM.png`
- `provenance.json`

## Coding checklist for AI tools
1. Inspect `landing.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
